const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./DarelogRoom-t-2fV8jw.js","./TalkRoom-DvslR0-R.js"])))=>i.map(i=>d[i]);
...
</svg>`,pi=`url("data:image/svg+xml,${encodeURIComponent(mg)}")`,Vg=["#ffffff","#fff5fa","#ffd9ec","#ffc4e1","#ff9fd0","#e0629f","#d4f0ff","#c9f5f2","#d9ffe3","#e8dcff","#f0f0f0","#2b2430"],rs=["#9C27B0","#E91E63","#FFEB3B","#2196F3","#4CAF50","#FF9800","#F44336","#00BCD4","#3F51B5","#8BC34A","#FF4081","#009688"],Yf=["#ff6fb2","#c58cff","#6fb8ff","#5fd6b0","#ffcf5f","#ff9d6f","#7ed957","#ff8fa8"],Zr=Yf[0],wu=e=>{const t=e||Zr;return{background:`linear-gradient(163deg, #ffffff 0%, #fff6fb 40%, ${t}2e 100%)`,boxShadow:`0 6px 13px ${t}42, 0 2px 0 ${t}66, inset 0 1.5px 0 #ffffff`,borderColor:`${t}55`}},Qg=[{key:"auto",label:"自動",value:null},{key:"white",label:"白",value:"#ffffff"},{key:"black",label:"黒",value:"#222028"},{key:"pink",label:"ピンク",value:"#ff2d87"}],gg=e=>{const t=String(e).replace("#","");if(t.length<6)return"#4a3140";const n=parseInt(t.slice(0,2),16),r=parseInt(t.slice(2,4),16),o=parseInt(t.slice(4,6),16);return .299*n+.587*r+.114*o<140?"#fff5fa":"#4a3140"},Yg=e=>e&&e.textColor?e.textColor:gg(e&&e.color),ku=`
...
`)[0]}`,date:ue(B.dateKey)})}Y.length===0&&O.name.toLowerCase().includes(y)&&Y.push({snippet:O.preview||"",date:""}),Y.length&&E.push({room:O,hits:Y})}return E},[l,c,qn,e]),Mr=y=>l?y.split(new RegExp(`(${Vf(l)})`,"gi")).map((O,P)=>O.toLowerCase()===l.toLowerCase()?s.jsx("mark",{className:"hl",children:O},P):O):y,Sl=()=>{const y=p.name.trim();if(!y){ne("ルーム名を入れてね");return}const E={diary:"💗",todo:"✅",darelog:"🌗",expense:"💰",talk:"🩷"}[p.type]||"🩷",O=p.type==="darelog"?[{id:Ce(),name:"ブルー",color:"#d4f0ff",icon:{type:"emoji",value:"🌊"},side:"left"},{id:Ce(),name:"グリーン",color:"#d9ffe3",icon:{type:"emoji",value:"🌿"},side:"left"},{id:Ce(),name:"ピンク",color:"#ffd9ec",icon:{type:"emoji",value:"🌸"},side:"right"}]:[],P=p.type==="expense"?[{id:Ce(),name:"AI費用",emoji:"🤖",color:"#2196F3"},{id:Ce(),name:"ピンクグッズ",emoji:"🎀",color:"#E91E63"},{id:Ce(),name:"ネイル",emoji:"💅",color:"#9C27B0"},{id:Ce(),name:"旅費交通費",emoji:"🚃",color:"#00A5B5",transit:!0}]:void 0,Y={id:Ce(),type:p.type,name:y,emoji:p.emoji.trim()||E,theme:p.theme||Zr,members:O,createdAt:Date.now(),lastAt:0,preview:"",...p.type==="todo"?{shopping:!!p.shopping}:{},...P?{categories:P,subscriptions:[],subsPosted:{},transitSeeded:!0,stations:[],fares:[],defaultFromId:null,roundTripDefault:!1,incomeSeeded:!0,incomeCategories:[{id:Ce(),name:"売上",emoji:"💰",color:"#2E9E5B"},{id:Ce(),name:"返金",emoji:"↩️",color:"#3BA7A0"},{id:Ce(),name:"その他",emoji:"✨",color:"#7FB800"}]}:{}};Ze([...e,Y]),m(null),r({screen:"room",roomId:Y.id})},jl=()=>{const y=p.name.trim();if(!y){ne("ルーム名を入れてね");return}qe(p.roomId,{name:y,emoji:p.emoji.trim()||"💗",theme:p.theme||Zr,hidden:!!p.hidden,...p.type==="todo"?{shopping:!!p.shopping}:{}}),m(null)},Or=y=>{m({mode:"edit",roomId:y.id,name:y.name,emoji:y.emoji,type:y.type,shopping:!!y.shopping,theme:y.theme||Zr,hidden:!!y.hidden}),w(!1)},Ut=async y=>{try{const E=await W(Ae(y));E&&await Q(Km(y),E),Ze(e.filter(O=>O.id!==y)),m(null),k(null),ne("ルームを削除しました")}catch{ne("削除に失敗しました")}},Io=()=>{const y=e.find(E=>E.id===p.roomId);k({message:`ルーム「${(y==null?void 0:y.name)||""}」を削除しますか？
中の記録もすべて消えます。`,onConfirm:()=>Ut(p.roomId)})},Ao=async()=>{ie(""),He(!1);try{const y=await vu();st(JSON.stringify(y,null,2))}catch{st("")}ee(!0)},Ht=async()=>{const y={...ce||{},lastDateKey:tt(),lastAt:Date.now()};Ue(y);try{await Q(es,y)}catch{}},Fo=y=>{const E=new Blob([y],{type:"application/json;charset=utf-8"}),O=URL.createObjectURL(E),P=document.createElement("a");P.href=O,P.download=fi,document.body.appendChild(P),P.click(),P.remove(),setTimeout(()=>URL.revokeObjectURL(O),3e3)},Kt=async()=>{if(!ln){Oo(!0);try{let y;try{y=JSON.stringify(await vu(),null,2)}catch{ne("バックアップの作成に失敗しました 🥺");return}try{const E=new File([y],fi,{type:"application/json"});if(navigator.canShare&&navigator.canShare({files:[E]})){await navigator.share({files:[E],title:fi}),await Ht(),ne("バックアップを保存したよ💗 同じファイルに置き換えできたかな？");return}}catch(E){if(E&&(E.name==="AbortError"||E.name==="NotAllowedError"))return}try{Fo(y),await Ht(),ne("バックアップを保存したよ💗 iCloud/ファイルに入れておくと安心")}catch{ne("保存できない環境みたい。コピーを使ってね")}}finally{Oo(!1)}}},Bo=()=>{try{Fo(ae),Ht(),ne("バックアップを保存したよ💗 iCloud/ファイルに入れておくと安心")}catch{ne("保存できない環境みたい。コピーを使ってね")}},er=tt(),Wt=(()=>{if(!(ce!=null&&ce.lastDateKey))return null;const y=je(er)-je(ce.lastDateKey);return Math.max(0,Math.round(y/864e5))})(),Rr=Wt===null||Wt>=7,Uo=!!ce&&ce.lastDateKey!==er&&ce.dismissedDateKey!==er,Ho=async()=>{const y={...ce||{},dismissedDateKey:er};Ue(y);try{await Q(es,y)}catch{}},Ko=async()=>{try{await navigator.clipboard.writeText(ae),He(!0),setTimeout(()=>He(!1),2e3)}catch{ne("コピーできませんでした。全選択して手動でコピーしてね")}},Ln=y=>{var P;const E=(P=y.target.files)==null?void 0:P[0];if(!E)return;const O=new FileReader;O.onload=()=>ie(String(O.result||"")),O.onerror=()=>ne("ファイルを読めませんでした"),O.readAsText(E),y.target.value=""},Nl=()=>{let y;try{y=JSON.parse(Je)}catch{ne("JSONとして読めませんでした。ファイルが壊れているかも 🥺",4e3);return}const E=dg(y);if(E){ne(E,4500);return}En({obj:y,counts:fg(y),exportedAt:y.exportedAt||"",version:y.version})},$r=async()=>{const y=xt==null?void 0:xt.obj;if(y)try{const E=await hg(y);t(E.rooms),y.declaration&&y.declaration.dateKey===tt()&&!L&&(await Q(Ci,y.declaration),g(y.declaration.text)),D(O=>O+1),En(null),ee(!1),ie(""),ne(`復元完了💗 ${E.addedRooms}ルーム / ${E.addedItems}件を追加`)}catch{En(null),ne("復元中にエラーが出ました。ファイルが壊れているかも 🥺",4e3)}};if(!e)return s.jsx("div",{className:"app",children:s.jsx("style",{children:ku})});const Wo=s.jsxs("div",{className:"pin",onClick:()=>{S(L),u(L?"view":"edit")},role:"button",children:[s.jsx("span",{className:"pin-ic",children:L?"📌":"🩷"}),L?s.jsx("span",{className:"pin-txt",children:L}):s.jsx("span",{className:"pin-ph",children:"今日のコマをえらぶ🩷"})]});let tr;if(n.screen==="room"){const y=e.find(E=>E.id===n.roomId);if(!y)tr=null,setTimeout(()=>r({screen:"home"}),0);else{const E={room:y,onBack:()=>r({screen:"home"}),onMeta:P=>qe(y.id,P),initialQuery:n.q,showToast:ne,pinned:Wo},O=y.type==="diary"?s.jsx(Ng,{...E,syncSignal:z,marks:Ne,onEditMarks:()=>Ge(!0)},y.id):y.type==="todo"?s.jsx(_g,{...E,onTodoComplete:wl,onTodoUncomplete:kl,onRoomChange:P=>qe(y.id,P),todoRooms:e.filter(P=>P.type==="todo"&&P.id!==y.id),onMoveTodo:Tr},y.id):y.type==="darelog"?s.jsx(Dg,{...E,onRoomChange:P=>qe(y.id,P)},y.id):y.type==="expense"?s.jsx(Lg,{...E,onRoomChange:P=>qe(y.id,P)},y.id):s.jsx(zg,{...E,onRoomChange:P=>qe(y.id,P)},y.id);tr=s.jsx(Eg,{onBack:()=>r({screen:"home"}),children:s.jsx(C.Suspense,{fallback:s.jsxs(s.Fragment,{children:[s.jsx("div",{className:"hd hd-loading"}),s.jsx("div",{className:"chat"})]}),children:O})},y.id)}}else tr=s.jsxs(s.Fragment,{children:[s.jsxs("div",{className:"hd hd-home",children:[s.jsx("div",{className:"app-brand",children:s.jsx("div",{className:"app-title",children:"💖Nachumin Lifelog💖"})}),s.jsx("button",{className:"icon-btn",style:{marginLeft:"auto"},"aria-label":"バックアップ",onClick:Ao,children:"💾"}),s.jsx("button",{className:"icon-btn","aria-label":"新しいルーム",onClick:()=>m({mode:"new",name:"",emoji:"",type:"talk"}),children:"➕"}),s.jsx("button",{className:"icon-btn","aria-label":"ぜんぶ検索",onClick:()=>{i(!o),a("")},children:o?"✕":"🔍"})]}),Uo&&s.jsxs("div",{className:"bk-banner"+(Rr?" stale":""),children:[s.jsxs("button",{className:"bk-main",onClick:Kt,disabled:ln,children:[s.jsx("span",{className:"bk-ttl",children:"💾 今日のバックアップ🩷"}),s.jsx("span",{className:"bk-sub",children:Wt===null?"まだ一度も保存していません":Rr?`最後の保存から ${Wt}日 たっています`:"タップで1ファイルに書き出し"})]}),s.jsx("button",{className:"bk-x","aria-label":"閉じる",onClick:Ho,children:"✕"})]}),o&&s.jsx("div",{className:"search-row",children:s.jsx("input",{autoFocus:!0,placeholder:"ぜんぶのルームから検索（ことば・話者・日付）",value:l,onChange:y=>a(y.target.value)})}),Pr?s.jsx("div",{className:"rooms",children:Pr.length===0?s.jsx("div",{className:"empty",children:"みつかりませんでした 🥺"}):Pr.map(({room:y,hits:E})=>s.jsxs("div",{className:"room-row",onClick:()=>r({screen:"room",roomId:y.id,q:l}),children:[s.jsx("div",{className:"r-ic",children:y.emoji}),s.jsxs("div",{className:"r-main",children:[s.jsx("div",{className:"r-name",children:y.name}),s.jsx("div",{className:"r-prev",children:Mr(E[0].snippet)})]}),s.jsxs("div",{className:"r-side",children:[s.jsxs("span",{className:"r-badge",children:[E.length,"件"]}),E[0].date&&s.jsx("span",{className:"r-date",children:E[0].date})]})]},y.id))}):s.jsx("div",{className:"home-scroll",ref:ye,onScroll:y=>{we.current=y.target.scrollTop},children:(()=>{const y=e.find(I=>I.id===ke),E=qn.filter(I=>I.id!==ke&&!I.hidden),O=qn.filter(I=>I.id!==ke&&I.hidden),P=je(tt()),Y=T?T.written?T.preview:`${P.getMonth()+1}/${P.getDate()}・きょうの分はまだ`:"…",Z=I=>{const B=[...I];Ze(e.map(te=>te.id===ke||te.hidden?te:B.shift()))};return s.jsxs(s.Fragment,{children:[y&&s.jsxs("button",{className:"diary-card",onClick:()=>r({screen:"room",roomId:y.id}),children:[s.jsx("span",{className:"dc-ic",children:y.emoji}),s.jsxs("span",{className:"dc-main",children:[s.jsx("span",{className:"dc-name",children:"DIARY"}),s.jsx("span",{className:"dc-sub",children:Y})]}),s.jsx("span",{className:"dc-arw",children:"›"})]}),s.jsx(Cg,{items:E,keyOf:I=>I.id,onReorder:Z,onLongPress:({item:I})=>{I&&Or(I)},footer:s.jsx("div",{className:"ig-cell ig-add",children:s.jsxs("div",{className:"ig-tile",role:"button",tabIndex:0,onClick:()=>m({mode:"new",name:"",emoji:"",type:"talk"}),onKeyDown:I=>I.key==="Enter"&&m({mode:"new",name:"",emoji:"",type:"talk"}),children:[s.jsx("span",{className:"ig-btn",children:"＋"}),s.jsx("span",{className:"ig-name",children:"つくる"})]})}),renderItem:I=>{const B=I.type==="todo"&&I.todoOpen>0?I.todoOpen:null;return s.jsxs("div",{className:"ig-tile",role:"button",tabIndex:0,onClick:()=>r({screen:"room",roomId:I.id}),onKeyDown:te=>te.key==="Enter"&&r({screen:"room",roomId:I.id}),children:[s.jsxs("span",{className:"ig-btn",style:wu(I.theme),children:[I.emoji,B!=null&&s.jsx("span",{className:"ig-badge",children:B>99?"99+":B})]}),s.jsx("span",{className:"ig-name",children:I.name})]})}}),O.length>0&&s.jsx("button",{className:"hidden-entry",onClick:()=>G(!0),children:"🙈 非表示のルーム"}),A&&s.jsx("div",{className:"overlay",onClick:()=>G(!1),children:s.jsxs("div",{className:"panel",onClick:I=>I.stopPropagation(),children:[s.jsx("h3",{children:"🙈 非表示のルーム"}),s.jsx("p",{className:"panel-note",children:"一覧に出していないルームです。中の記録は消えていません。「戻す」でまた表示できます。"}),s.jsx("div",{className:"move-list",children:O.map(I=>s.jsxs("div",{className:"move-item as-row",children:[s.jsx("span",{className:"move-ic",children:I.emoji}),s.jsx("span",{className:"move-name",children:I.name}),s.jsx("button",{className:"unhide-btn",onClick:()=>qe(I.id,{hidden:!1}),children:"戻す"})]},I.id))}),s.jsx("div",{className:"panel-btns",children:s.jsx("button",{className:"p-close",onClick:()=>G(!1),children:"閉じる"})})]})})]})})()})]});return s.jsxs("div",{className:"app",children:[s.jsx("style",{children:ku}),tr,p&&s.jsx("div",{className:"overlay",onClick:()=>{m(null),w(!1)},children:s.jsxs("div",{className:"panel",onClick:y=>y.stopPropagation(),children:[s.jsx("h3",{children:p.mode==="new"?"➕ 新しいルーム":"⚙️ ルーム設定"}),s.jsx("div",{className:"f-label",children:"ルーム名"}),s.jsx("input",{className:"f-input",autoFocus:p.mode==="new",placeholder:"ハートるんず",value:p.name,onChange:y=>m(E=>({...E,name:y.target.value}))}),s.jsx("div",{className:"f-label",children:"アイコン（タップで選ぶ）"}),s.jsx("div",{className:"emoji-picks",children:Tg.map(y=>s.jsx("button",{className:"emoji-pick"+(p.emoji===y?" on":""),onClick:()=>m(E=>({...E,emoji:y})),children:y},y))}),s.jsx("input",{className:"f-input",style:{width:130,textAlign:"center",marginTop:4},maxLength:8,placeholder:"または自由入力",value:p.emoji,onChange:y=>m(E=>({...E,emoji:y.target.value}))}),s.jsx("div",{className:"f-label",children:"テーマカラー"}),s.jsx("div",{className:"theme-swatches",children:Yf.map(y=>{const E=(p.theme||Zr)===y;return s.jsx("button",{className:"theme-sw"+(E?" on":""),style:wu(y),"aria-label":y,onClick:()=>m(O=>({...O,theme:y}))},y)})}),s.jsxs("div",{className:"f-label",children:["タイプ",p.mode==="edit"?"（変更できません）":""]}),s.jsxs("div",{className:"type-row",children:[s.jsxs("button",{className:"type-chip"+(p.type==="diary"?" on":""),disabled:p.mode==="edit",onClick:()=>m(y=>({...y,type:"diary"})),children:["📖 日記",s.jsx("small",{children:"1日=1吹き出し"})]}),s.jsxs("button",{className:"type-chip"+(p.type==="talk"?" on":""),disabled:p.mode==="edit",onClick:()=>m(y=>({...y,type:"talk"})),children:["💬 トーク",s.jsx("small",{children:"話者ごと"})]}),s.jsxs("button",{className:"type-chip"+(p.type==="todo"?" on":""),disabled:p.mode==="edit",onClick:()=>m(y=>({...y,type:"todo"})),children:["✅ TODO",s.jsx("small",{children:"やること"})]}),s.jsxs("button",{className:"type-chip"+(p.type==="darelog"?" on":""),disabled:p.mode==="edit",onClick:()=>m(y=>({...y,type:"darelog"})),children:["🌗 だれログ",s.jsx("small",{children:"朝昼夜の記録"})]}),s.jsxs("button",{className:"type-chip"+(p.type==="expense"?" on":""),disabled:p.mode==="edit",onClick:()=>m(y=>({...y,type:"expense"})),children:["💰 経費",s.jsx("small",{children:"支出を記録"})]})]}),p.mode==="edit"&&p.roomId!==ke&&s.jsxs(s.Fragment,{children:[s.jsx("div",{className:"f-label",children:"一覧での表示"}),s.jsxs("button",{className:"shop-toggle"+(p.hidden?" on":""),onClick:()=>m(y=>({...y,hidden:!y.hidden})),children:[s.jsx("span",{className:"shop-box",children:p.hidden?"✓":""}),"🙈 一覧に表示しない（記録は消えません）"]})]}),p.type==="todo"&&s.jsxs(s.Fragment,{children:[s.jsx("div",{className:"f-label",children:"用途"}),s.jsxs("button",{className:"shop-toggle"+(p.shopping?" on":""),onClick:()=>m(y=>({...y,shopping:!y.shopping})),children:[s.jsx("span",{className:"shop-box",children:p.shopping?"✓":""}),"🛒 買い物リストとして使う（よく買うものクイック追加）"]})]}),s.jsxs("div",{className:"panel-btns",children:[s.jsx("button",{className:"p-copy",onClick:p.mode==="new"?Sl:jl,children:p.mode==="new"?"つくる":"保存"}),p.mode==="edit"&&s.jsx("button",{className:"p-del",onClick:Io,children:"削除"}),s.jsx("button",{className:"p-close",onClick:()=>{m(null),w(!1)},children:"閉じる"})]})]})}),V&&s.jsx("div",{className:"overlay",onClick:()=>ee(!1),children:s.jsxs("div",{className:"panel",onClick:y=>y.stopPropagation(),children:[s.jsx("h3",{children:"💾 まるごとバックアップ"}),s.jsx("p",{className:"panel-note",children:"全ルーム・全データ（日記 / TODO / だれログ / 経費 / 習慣 / 各種設定）を まるごと1ファイルに保存します。端末が変わっても元どおり復元できます。"}),s.jsxs("div",{className:"bk-last"+(Rr?" stale":""),children:[s.jsx("span",{className:"bk-last-l",children:"最後にバックアップした日"}),s.jsx("span",{className:"bk-last-v",children:ce!=null&&ce.lastDateKey?`${ue(ce.lastDateKey)}${Wt===0?"（今日）":`（${Wt}日前）`}`:"まだありません"})]}),s.jsxs("div",{className:"panel-btns",children:[s.jsx("button",{className:"p-copy",onClick:Kt,disabled:ln,children:"💾 1タップで書き出し"}),s.jsx("button",{className:"p-dl",onClick:Bo,children:"ダウンロード"}),s.jsx("button",{className:"p-dl",onClick:Ko,children:Ro?"コピーしたよ💗":"コピー"})]}),s.jsxs("p",{className:"panel-note",children:["ファイル名は毎回 ",s.jsx("b",{children:fi})," で固定。iPhoneの共有シートから 「ファイルに保存」を選ぶと、前のファイルを置き換えて上書きできます。"]}),s.jsx("div",{className:"f-label",style:{marginTop:6},children:"復元する（バックアップから読み込み）"}),s.jsx("p",{className:"panel-note",children:"既存のデータは消さず、足りない分だけ追加します（安全マージ）"}),s.jsxs("label",{className:"upload-btn",style:{alignSelf:"flex-start"},children:["📂 バックアップファイルを選ぶ",s.jsx("input",{type:"file",accept:".json,application/json,text/plain",onChange:Ln})]}),s.jsx("textarea",{placeholder:"または、コピーしたバックアップをここに貼り付け",value:Je,onChange:y=>ie(y.target.value),style:{minHeight:120}}),s.jsxs("div",{className:"panel-btns",children:[s.jsx("button",{className:"p-copy",disabled:!Je.trim(),onClick:Nl,children:"復元する"}),s.jsx("button",{className:"p-close",onClick:()=>{ee(!1),ie("")},children:"閉じる"})]})]})}),xt&&s.jsx("div",{className:"overlay bk-ask-over",onClick:()=>En(null),children:s.jsxs("div",{className:"panel",onClick:y=>y.stopPropagation(),children:[s.jsx("h3",{children:"⚠️ 復元まえの確認"}),s.jsxs("div",{className:"bk-ask-box",children:[s.jsxs("div",{className:"bk-ask-row",children:[s.jsx("span",{children:"ルーム"}),s.jsx("b",{children:xt.counts.rooms})]}),s.jsxs("div",{className:"bk-ask-row",children:[s.jsx("span",{children:"記録の件数"}),s.jsx("b",{children:xt.counts.items})]}),xt.exportedAt&&s.jsxs("div",{className:"bk-ask-row",children:[s.jsx("span",{children:"書き出し日時"}),s.jsx("b",{children:new Date(xt.exportedAt).toLocaleString("ja-JP")})]})]}),s.jsxs("p",{className:"panel-note",children:["今のデータは消えません（足りない分を追加する安全マージ）。 それでも念のため、",s.jsx("b",{children:"先に今のデータをバックアップ"}),"しておくのがおすすめです💗"]}),s.jsx("button",{className:"bk-first",onClick:Kt,disabled:ln,children:"💾 先に今のデータをバックアップする"}),s.jsxs("div",{className:"panel-btns",children:[s.jsx("button",{className:"p-copy",onClick:$r,children:"この内容で復元する"}),s.jsx("button",{className:"p-close",onClick:()=>En(null),children:"キャンセル"})]})]})}),d&&s.jsx("div",{className:"overlay",onClick:()=>u(null),children:s.jsxs("div",{className:"panel",onClick:y=>y.stopPropagation(),children:[s.jsx("h3",{children:"🩷 今日のコマ"}),d==="view"?s.jsxs(s.Fragment,{children:[s.jsx("div",{className:"decl-full",children:L}),s.jsx("p",{className:"panel-note",children:"その日1日だけピン留め。日記にも記録されています🎬"}),s.jsxs("div",{className:"panel-btns",children:[s.jsx("button",{className:"p-copy",onClick:()=>{S(L),u("edit")},children:"書きなおす"}),s.jsx("button",{className:"p-close",onClick:()=>u(null),children:"閉じる"})]})]}):s.jsxs(s.Fragment,{children:[s.jsx("textarea",{autoFocus:!0,style:{minHeight:120},placeholder:"今日は愛全開の私でいる！",value:v,onChange:y=>S(y.target.value)}),s.jsx("p",{className:"panel-note",children:"その日1日だけ表示。決定すると今日の日記の先頭に🎬として残ります"}),s.jsxs("div",{className:"panel-btns",children:[s.jsx("button",{className:"p-copy",disabled:!v.trim(),onClick:()=>{_n(v),u(null)},children:"決定"}),s.jsx("button",{className:"p-close",onClick:()=>u(null),children:"閉じる"})]})]})]})}),gt&&s.jsx("div",{className:"overlay",onClick:()=>Ge(!1),children:s.jsxs("div",{className:"panel",onClick:y=>y.stopPropagation(),children:[s.jsx("h3",{children:"⚙︎ 箇条書きマーク"}),s.jsx("p",{className:"panel-note",children:"日記の入力欄に出るマーク。タップで削除、下から追加できます。"}),s.jsxs("div",{className:"mark-manage",children:[Ne.map(y=>s.jsxs("span",{className:"mark-item",children:[y,s.jsx("button",{onClick:()=>bl(y),"aria-label":"削除",children:"✕"})]},y)),Ne.length===0&&s.jsx("p",{className:"panel-note",children:"マークがありません。追加してね"})]}),s.jsxs("div",{className:"in-row",style:{marginTop:4},children:[s.jsx("input",{className:"f-input",maxLength:4,placeholder:"記号や絵文字（例: ❤︎）",value:M,onChange:y=>H(y.target.value),onKeyDown:y=>y.key==="Enter"&&Dn()}),s.jsx("button",{className:"p-copy",style:{flex:"0 0 auto",padding:"8px 16px",borderRadius:999},disabled:!M.trim(),onClick:Dn,children:"追加"})]}),s.jsx("div",{className:"panel-btns",children:s.jsx("button",{className:"p-close",onClick:()=>Ge(!1),children:"閉じる"})})]})}),b&&s.jsx(Zf,{message:b.message,onConfirm:b.onConfirm,onCancel:()=>k(null)}),Bt&&s.jsx("div",{className:"toast",children:Bt})]})}let Nu=!1,Cu=!!(navigator.serviceWorker&&navigator.serviceWorker.controller);navigator.serviceWorker&&navigator.serviceWorker.addEventListener("controllerchange",()=>{if(!Cu){Cu=!0;return}Nu||(Nu=!0,window.location.reload())});zm({immediate:!0,onRegisteredSW(e,t){t&&(t.update(),setInterval(()=>t.update(),60*60*1e3),document.addEventListener("visibilitychange",()=>{document.visibilityState==="visible"&&t.update()}))}});Vm();Ff(document.getElementById("root")).render(s.jsx(C.StrictMode,{children:s.jsx(Pg,{})}));export{$g as A,Ig as B,vg as C,Og as D,Rg as E,Mg as F,xu as G,xg as I,rs as M,bu as P,og as S,Qg as T,ta as W,Ae as a,ue as b,yu as c,tl as d,Zf as e,tt as f,W as g,Wg as h,Vf as i,s as j,je as k,Sg as l,Q as m,Wf as n,Yg as o,Kg as p,Ag as q,C as r,tg as s,gg as t,Ce as u,Ug as v,Hg as w,Fg as x,Bg as y,Vg as z};
