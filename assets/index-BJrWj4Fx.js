const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./DarelogRoom-Ccs_22Wa.js","./TalkRoom-BHplBmXk.js"])))=>i.map(i=>d[i]);
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(M,B){var U=M.length;M.push(B);e:for(;0<U;){var Z=U-1>>>1,te=M[Z];if(0<o(te,B))M[Z]=B,M[U]=te,U=Z;else break e}}function n(M){return M.length===0?null:M[0]}function r(M){if(M.length===0)return null;var B=M[0],U=M.pop();if(U!==B){M[0]=U;e:for(var Z=0,te=M.length,ue=te>>>1;Z<ue;){var J=2*(Z+1)-1,Ne=M[J],we=J+1,Et=M[we];if(0>o(Ne,U))we<te&&0>o(Et,Ne)?(M[Z]=Et,M[we]=U,Z=we):(M[Z]=Ne,M[J]=U,Z=J);else if(we<te&&0>o(Et,U))M[Z]=Et,M[we]=U,Z=we;else break e}}return B}function o(M,B){var U=M.sortIndex-B.sortIndex;return U!==0?U:M.id-B.id}if(typeof performance=="object"&&typeof performance.now=="function"){var i=performance;e.unstable_now=function(){return i.now()}}else{var l=Date,s=l.now();e.unstable_now=function(){return l.now()-s}}var a=[],c=[],m=1,g=null,d=3,v=!1,b=!1,S=!1,P=typeof setTimeout=="function"?setTimeout:null,h=typeof clearTimeout=="function"?clearTimeout:null,f=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function p(M){for(var B=n(c);B!==null;){if(B.callback===null)r(c);else if(B.startTime<=M)r(c),B.sortIndex=B.expirationTime,t(a,B);else break;B=n(c)}}function w(M){if(S=!1,p(M),!b)if(n(a)!==null)b=!0,tt(j);else{var B=n(c);B!==null&&ct(w,B.startTime-M)}}function j(M,B){b=!1,S&&(S=!1,h(T),T=-1),v=!0;var U=d;try{for(p(B),g=n(a);g!==null&&(!(g.expirationTime>B)||M&&!X());){var Z=g.callback;if(typeof Z=="function"){g.callback=null,d=g.priorityLevel;var te=Z(g.expirationTime<=B);B=e.unstable_now(),typeof te=="function"?g.callback=te:g===n(a)&&r(a),p(B)}else r(a);g=n(a)}if(g!==null)var ue=!0;else{var J=n(c);J!==null&&ct(w,J.startTime-B),ue=!1}return ue}finally{g=null,d=U,v=!1}}var D=!1,L=null,T=-1,F=5,I=-1;function X(){return!(e.unstable_now()-I<F)}function he(){if(L!==null){var M=e.unstable_now();I=M;var B=!0;try{B=L(!0,M)}finally{B?et():(D=!1,L=null)}}else D=!1}var et;if(typeof f=="function")et=function(){f(he)};else if(typeof MessageChannel<"u"){var ut=new MessageChannel,cn=ut.port2;ut.port1.onmessage=he,et=function(){cn.postMessage(null)}}else et=function(){P(he,0)};function tt(M){L=M,D||(D=!0,et())}function ct(M,B){T=P(function(){M(e.unstable_now())},B)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(M){M.callback=null},e.unstable_continueExecution=function(){b||v||(b=!0,tt(j))},e.unstable_forceFrameRate=function(M){0>M||125<M?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):F=0<M?Math.floor(1e3/M):5},e.unstable_getCurrentPriorityLevel=function(){return d},e.unstable_getFirstCallbackNode=function(){return n(a)},e.unstable_next=function(M){switch(d){case 1:case 2:case 3:var B=3;break;default:B=d}var U=d;d=B;try{return M()}finally{d=U}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(M,B){switch(M){case 1:case 2:case 3:case 4:case 5:break;default:M=3}var U=d;d=M;try{return B()}finally{d=U}},e.unstable_scheduleCallback=function(M,B,U){var Z=e.unstable_now();switch(typeof U=="object"&&U!==null?(U=U.delay,U=typeof U=="number"&&0<U?Z+U:Z):U=Z,M){case 1:var te=-1;break;case 2:te=250;break;case 5:te=1073741823;break;case 4:te=1e4;break;default:te=5e3}return te=U+te,M={id:m++,callback:B,priorityLevel:M,startTime:U,expirationTime:te,sortIndex:-1},U>Z?(M.sortIndex=U,t(c,M),n(a)===null&&M===n(c)&&(S?(h(T),T=-1):S=!0,ct(w,U-Z))):(M.sortIndex=te,t(a,M),b||v||(b=!0,tt(j))),M},e.unstable_shouldYield=X,e.unstable_wrapCallback=function(M){var B=d;return function(){var U=d;d=B;try{return M.apply(this,arguments)}finally{d=U}}}})(uc);ac.exports=uc;var Kf=ac.exports;/**
 * @license React
...
`)[0].slice(0,40):"",lastAt:e.lastAt||(o?Date.now():0)}}async function Hu(){const e=await V(Mt)||[],t={};for(const a of e){const c=await V(Oe(a.id));c!==void 0&&(t[a.id]=c)}const n=await V(Xo)||null,r={},o={},i={},l={};for(const a of e){const c=await V(Nn(a.id));c&&Object.keys(c).length&&(r[a.id]=c);const m=await V(Cn(a.id));Array.isArray(m)&&m.length&&(o[a.id]=m);const g=await V(ki(a.id));g&&Object.keys(g).length&&(i[a.id]=g),await V(bi(a.id))&&(l[a.id]=!0)}const s=await V(lo)||null;return{app:"nachumin-diary",version:1,exportedAt:new Date().toISOString(),rooms:e,data:t,declaration:n,doneLogs:r,habits:o,habitLogs:i,habitSeeds:l,marks:s}}const Pm=e=>e.map((t,n)=>[t,n]).sort((t,n)=>t[0].dateKey<n[0].dateKey?-1:t[0].dateKey>n[0].dateKey?1:t[1]-n[1]).map(([t])=>t);async function Mm(e){var s;if(!e||e.app!=="nachumin-diary"||!Array.isArray(e.rooms))throw new Error("invalid-backup");const t=await V(Mt)||[],n=new Map(t.map(a=>[a.id,{...a}]));let r=0,o=0;for(const a of e.rooms){const c=e.data?e.data[a.id]:void 0,m=a.type==="talk"?"messages":a.type==="todo"?"todos":a.type==="darelog"?"records":a.type==="expense"?"expenses":null,g=v=>m==="messages"?`${v.dateKey} ${v.memberId} ${v.text}`:m==="todos"?`${v.dateKey} ${v.text}`:m==="records"?`${v.dateKey} ${v.slot} ${v.memberId}`:v.id;if(!n.has(a.id)){c!==void 0&&await Y(Oe(a.id),c),n.set(a.id,{...a,...Ll(a,c)}),r+=1,m?o+=((s=c==null?void 0:c[m])==null?void 0:s.length)||0:o+=c?Object.keys(c).length:0;continue}const d=n.get(a.id);if(m){const b=(await V(Oe(a.id))||{})[m]||[],S=new Set(b.map(g));let P=b.slice();for(const p of(c==null?void 0:c[m])||[])S.has(g(p))||(S.add(g(p)),P.push(p),o+=1);m==="messages"&&(P=Pm(P));const h={[m]:P};await Y(Oe(a.id),h);let f={...d};if(a.type==="talk"||a.type==="darelog"){const p=d.members||[],w=new Set(p.map(j=>j.id));f.members=p.concat((a.members||[]).filter(j=>!w.has(j.id)))}n.set(a.id,{...f,...Ll(f,h)})}else{const b={...await V(Oe(a.id))||{}};for(const S of Object.keys(c||{}))b[S]||(b[S]=c[S],o+=1);await Y(Oe(a.id),b),n.set(a.id,{...d,...Ll(d,b)})}}if(e.doneLogs)for(const[a,c]of Object.entries(e.doneLogs)){const m=Nn(a),d={...await V(m)||{}};for(const[v,b]of Object.entries(c)){const S=(d[v]||[]).slice();for(const P of b)S.some(h=>h.text===P.text&&h.time===P.time)||S.push(P);d[v]=S}await Y(m,d)}const i={};if(e.habits)for(const[a,c]of Object.entries(e.habits)){if(!Array.isArray(c))continue;const m=await V(Cn(a));if(m===void 0){await Y(Cn(a),c);continue}const g=Array.isArray(m)?m:[],d=new Set(g.map(P=>P.id)),v=new Map(g.filter(P=>(P.name||"").trim()).map(P=>[P.name.trim(),P.id])),b=g.slice(),S={};for(const P of c){if(!P||!P.id)continue;if(d.has(P.id)){S[P.id]=P.id;continue}const h=(P.name||"").trim(),f=h?v.get(h):null;if(f){S[P.id]=f;continue}b.push(P),d.add(P.id),h&&v.set(h,P.id),S[P.id]=P.id}b.length!==g.length&&await Y(Cn(a),b),i[a]=S}if(e.habitSeeds)for(const a of Object.keys(e.habitSeeds))e.habitSeeds[a]&&await Y(bi(a),!0);if(e.habitLogs)for(const[a,c]of Object.entries(e.habitLogs)){const m=i[a]||{},g=ki(a),v={...await V(g)||{}};for(const[b,S]of Object.entries(c)){const P=(S||[]).map(h=>m[h]||h);v[b]=[...new Set([...v[b]||[],...P])]}await Y(g,v)}if(Array.isArray(e.marks)&&e.marks.length){const a=await V(lo);(!Array.isArray(a)||!a.length)&&await Y(lo,e.marks)}const l=[...n.values()];return await Y(Mt,l),{addedRooms:r,addedItems:o,rooms:l}}const gn="M12 20.5s-7.5-5-7.5-10a4.2 4.2 0 0 1 7.5-2.6A4.2 4.2 0 0 1 19.5 10.5c0 5-7.5 10-7.5 10z",Om=`<svg xmlns='http://www.w3.org/2000/svg' width='240' height='240' viewBox='0 0 240 240'>
...
`)},el=async x=>{const k=await Ku(x);o(k?"コピーしました🩷":"コピーできませんでした。手動でコピーしてね"),J(null)},xo=X.toLowerCase(),kt=Ye(),y=new Set([...Object.keys(c),...Object.keys(g),...Object.keys(S)]);v.length&&y.add(kt);let C=[...y].sort();X&&(C=C.filter(x=>{const k=c[x]&&(c[x].text+de(x)).toLowerCase().includes(xo),N=(g[x]||[]).some(_=>_.text.toLowerCase().includes(xo));return k||N}));const O=de(j).slice(5),R=(x,k)=>u.jsx("button",{className:"chip"+(j===k?" chip-on":""),onClick:()=>D(k),children:x},x);return u.jsxs(u.Fragment,{children:[u.jsxs("div",{className:"hd",children:[u.jsx("button",{className:"back-btn","aria-label":"もどる",onClick:t,children:"‹"}),u.jsx("span",{style:{fontSize:20},children:e.emoji}),u.jsxs("div",{children:[u.jsx("div",{className:"hd-title",children:e.name}),u.jsx("div",{className:"hd-sub",children:"Nachumin Lifelog"})]}),u.jsx("button",{className:"icon-btn",style:{marginLeft:"auto"},"aria-label":"マークで集める",onClick:Gi,children:"🔖"}),u.jsx("button",{className:"icon-btn","aria-label":"習慣",onClick:()=>U(!0),children:"🎯"}),u.jsx("button",{className:"icon-btn","aria-label":"テキスト書き出し",onClick:()=>ut(!0),children:"📤"}),u.jsx("button",{className:"icon-btn","aria-label":"テキストから復元",onClick:()=>tt(!0),children:"📥"}),u.jsx("button",{className:"icon-btn","aria-label":"検索",onClick:()=>{I(!F),he("")},children:F?"✕":"🔍"})]}),i,F&&u.jsx("div",{className:"search-row",children:u.jsx("input",{autoFocus:!0,placeholder:"日記を検索（ことば・日付）",value:X,onChange:x=>he(x.target.value)})}),u.jsxs("div",{className:"chat",ref:Ae,style:{paddingBottom:p?210:dn+12},children:[h&&C.length===0&&u.jsx("div",{className:"empty",children:X?"みつかりませんでした 🥺":`まだ日記がありません。
下から今日のことを書いてみよう💗`}),C.map(x=>{const k=p===x,N=!!c[x],_=g[x]||[],A=x===kt,W=S[x]||[],ne=Ke(x).getDay(),Ce=v.filter(K=>K.freq==="weekly"?(K.days||[]).includes(ne):!0),Fe=Ce.length>0&&(A||N||W.length>0),xe=_.length>0||Fe;return u.jsxs(z.Fragment,{children:[N&&u.jsxs("div",{className:"row","data-date":x,children:[u.jsx("div",{className:"time",children:c[x].time}),u.jsxs(Qu,{className:"bubble"+(k?" editing-now":""),onClick:k?void 0:()=>vt(x),onLongPress:k?void 0:K=>J({type:"diary",k:x,x:K.x,y:K.y}),role:"button",tabIndex:0,onKeyDown:K=>!k&&K.key==="Enter"&&vt(x),children:[u.jsx("span",{className:"spark",children:"✨"}),u.jsxs("div",{className:"d-head",children:["🩷",u.jsxs("span",{className:"lnk"+(Si(x)?" wd-"+Si(x):""),children:[de(x)," ",Bu[Ke(x).getDay()]]}),"🩷"]}),k?u.jsx($m,{initial:c[x].text,appendNewline:!0,marks:s,onEditMarks:a,bottomToolbar:!0,onSave:K=>Wi(x,K),onCancel:()=>w(null),onDelete:()=>Rn(x),placeholder:"内容を書きなおしてね"}):u.jsx("div",{className:"body",children:zt(c[x].text)})]})]}),xe&&u.jsx("div",{className:"done-row",style:N?void 0:{marginTop:0},children:u.jsxs(Qu,{className:"done-bubble",onLongPress:K=>J({type:"done",k:x,x:K.x,y:K.y}),children:[u.jsxs("div",{className:"done-head",children:[u.jsx("span",{children:"🩷 できたこと"}),Fe&&u.jsx("button",{className:"hv-open","aria-label":"習慣ビューをひらく",onClick:K=>{K.stopPropagation(),te(!0)},children:"🎯 習慣ビュー"})]}),_.map((K,dt)=>u.jsxs("div",{className:"done-line",children:["☑ ",zt(K.text),K.time?u.jsxs("span",{className:"done-time",children:[" (",K.time,")"]}):null]},dt)),Fe&&u.jsx("div",{className:"habits-row"+(_.length?" has-sep":""),children:Ce.map(K=>{const dt=W.includes(K.id);return u.jsxs("button",{className:"habit-chip"+(dt?" on":""),onClick:()=>$n(x,K.id),children:[K.emoji?K.emoji+" ":"",K.name,dt?" 🩷":""]},K.id)})})]})})]},x)})]}),!p&&u.jsxs("div",{className:"bar bar-fixed",ref:Ut,style:{bottom:q},children:[u.jsxs("div",{className:"chips",children:[R("今日",kt),R("昨日",Uu()),u.jsxs("button",{className:"chip chip-date",children:["📅 ",j===kt||j===Uu()?"日付をえらぶ":O,u.jsx("input",{type:"date",value:j,onChange:x=>x.target.value&&D(x.target.value)})]}),c[j]&&u.jsx("span",{className:"exists-note",children:"この日はもうあるので追記されます"})]}),s&&s.length>0&&u.jsx(vf,{marks:s,onInsert:xr,onEdit:a}),u.jsxs("div",{className:"in-row",children:[u.jsx("textarea",{ref:Bt,className:"ta",rows:1,placeholder:j===kt?"今日あったことを書く…":`${O} に追記…`,value:L,onChange:Hi}),u.jsx("button",{className:"send","aria-label":"送信",disabled:!L.trim(),onClick:Ki,children:"↑"})]})]}),ue&&u.jsx(Am,{x:ue.x,y:ue.y,onClose:()=>J(null),onCopy:()=>{var x;return el(`🩷${de(ue.k)}🩷
...
日記の入力欄でマークを押して書くと集まります💗`}):(wt.byMark[Ne]||[]).map((x,k)=>u.jsxs("button",{className:"mv-row",onClick:()=>Ji(x.dateKey),children:[u.jsx("span",{className:"mv-date",children:de(x.dateKey).slice(5)}),u.jsx("span",{className:"mv-text",children:x.text})]},k))})]}),Z&&u.jsx(Fm,{habits:v,habitAch:S,onToggle:$n,onClose:()=>te(!1),onManage:()=>U(!0)}),B&&u.jsx("div",{className:"overlay habit-over",onClick:In,children:u.jsxs("div",{className:"panel",onClick:x=>x.stopPropagation(),children:[u.jsx("h3",{children:"🎯 習慣"}),u.jsx("p",{className:"panel-note",children:"毎日くり返すこと。日記の「できたこと」からワンタップで記録できます。"}),v.map((x,k)=>u.jsxs("div",{className:"mem-row",style:{flexWrap:"wrap"},children:[u.jsx("input",{className:"f-input",style:{width:54,textAlign:"center",flex:"0 0 auto"},maxLength:4,placeholder:"🩷",value:x.emoji||"",onChange:N=>mn(x.id,{emoji:N.target.value})}),u.jsx("input",{className:"f-input",style:{flex:1,minWidth:0},placeholder:"習慣の名前",value:x.name,onChange:N=>mn(x.id,{name:N.target.value})}),u.jsx("button",{className:"mem-btn",disabled:k===0,onClick:()=>go(k,-1),"aria-label":"上へ",children:"↑"}),u.jsx("button",{className:"mem-btn",disabled:k===v.length-1,onClick:()=>go(k,1),"aria-label":"下へ",children:"↓"}),u.jsx("button",{className:"mem-btn",onClick:()=>Yi(x.id),"aria-label":"削除",children:"🗑"}),u.jsxs("div",{className:"seg",style:{flexBasis:"100%",marginTop:4},children:[u.jsx("button",{className:x.freq!=="weekly"?"on":"",onClick:()=>mo(x.id,"daily"),children:"毎日"}),u.jsx("button",{className:x.freq==="weekly"?"on":"",onClick:()=>mo(x.id,"weekly"),children:"毎週"})]}),x.freq==="weekly"&&u.jsx("div",{className:"dow-row",children:Bm.map(N=>u.jsx("button",{className:"dow-chip"+((x.days||[]).includes(N)?" on":""),onClick:()=>Qi(x.id,N),children:Bu[N]},N))})]},x.id)),v.length===0&&u.jsx("p",{className:"panel-note",children:"まだ習慣がありません。追加してね💗"}),u.jsxs("div",{className:"panel-btns",children:[u.jsx("button",{className:"p-copy",onClick:Vi,children:"＋ 習慣を追加"}),u.jsx("button",{className:"p-close",onClick:In,children:"閉じる"})]})]})}),et&&u.jsx("div",{className:"overlay",onClick:()=>ut(!1),children:u.jsxs("div",{className:"panel",onClick:x=>x.stopPropagation(),children:[u.jsx("h3",{children:"📤 日記をテキストで書き出し"}),u.jsx("textarea",{ref:Mn,readOnly:!0,value:An()}),u.jsxs("div",{className:"panel-btns",children:[u.jsx("button",{className:"p-copy",onClick:yr,children:Et?"コピーしたよ💗":"ぜんぶコピー"}),u.jsx("button",{className:"p-dl",onClick:Xi,children:".txtでDL"}),u.jsx("button",{className:"p-close",onClick:()=>ut(!1),children:"閉じる"})]})]})}),cn&&u.jsx("div",{className:"overlay",onClick:()=>tt(!1),children:u.jsxs("div",{className:"panel",onClick:x=>x.stopPropagation(),children:[u.jsx("h3",{children:"📥 テキストから復元"}),u.jsx("textarea",{placeholder:`エクスポートした .txt の内容をここに貼り付けてね

🩷2026/07/17🩷 9:30
今日あったこと…`,value:ct,onChange:x=>M(x.target.value)}),u.jsx("p",{className:"panel-note",children:"※ すでにある日付の日記は上書きせずスキップされます"}),u.jsxs("div",{className:"panel-btns",children:[u.jsx("button",{className:"p-copy",disabled:!ct.trim(),onClick:Fn,children:"読み込む"}),u.jsx("button",{className:"p-close",onClick:()=>{tt(!1),M("")},children:"閉じる"})]})]})})]})}function Km({items:e,keyOf:t,onReorder:n,renderItem:r,onLongPress:o,longPress:i=400,footer:l}){const[s,a]=z.useState(null),[c,m]=z.useState(null),g=z.useRef(null),d=z.useRef({});d.current.items=e,d.current.keyOf=t,d.current.onReorder=n,d.current.onLongPress=o;const v=s||e,b=w=>{var j;return(j=g.current)==null?void 0:j.querySelector(`[data-dk="${CSS.escape(String(w))}"]`)},S=()=>{const w=g.current;if(!w||d.current.dragKey==null)return;const j=b(d.current.dragKey);if(!j)return;const D=w.getBoundingClientRect(),L=D.left+j.offsetLeft,T=D.top+j.offsetTop,F=d.current.pointerX-d.current.grabX-L,I=d.current.pointerY-d.current.grabY-T;j.style.transform=`translate(${F}px, ${I}px) scale(1.08)`},P=w=>{const j=b(w);if(!j)return;const D=j.getBoundingClientRect();d.current.dragKey=w,d.current.grabX=d.current.pointerX-D.left,d.current.grabY=d.current.pointerY-D.top,d.current.pickupX=d.current.pointerX,d.current.pickupY=d.current.pointerY,d.current.moved=!1,d.current.order=d.current.items.slice(),j.style.zIndex="10",a(d.current.order),m(w);try{navigator.vibrate&&navigator.vibrate(12)}catch{}requestAnimationFrame(S)},h=()=>{const w=g.current;if(!w||d.current.dragKey==null)return;const j=[...w.querySelectorAll("[data-dk]")];let D=0,L=1/0;for(let I=0;I<j.length;I++){const X=j[I].getBoundingClientRect(),he=X.left+X.width/2,et=X.top+X.height/2,ut=(d.current.pointerX-he)**2+(d.current.pointerY-et)**2;ut<L&&(L=ut,D=I)}const T=d.current.order,F=T.findIndex(I=>d.current.keyOf(I)===d.current.dragKey);if(F!==-1&&F!==D){const[I]=T.splice(F,1);T.splice(D,0,I),a(T.slice())}requestAnimationFrame(S)},f=()=>{if(clearTimeout(d.current.timer),d.current.dragKey!=null){const w=b(d.current.dragKey);if(w&&(w.style.transform="",w.style.zIndex=""),d.current.moved)d.current.onReorder(d.current.order.slice());else if(d.current.onLongPress){const j=d.current.items.find(D=>d.current.keyOf(D)===d.current.dragKey);d.current.onLongPress({item:j,x:d.current.pointerX,y:d.current.pointerY})}d.current.suppress=Date.now()+450}d.current.dragKey=null,m(null),a(null)};z.useEffect(()=>{const w=g.current;if(!w)return;const j=T=>{if(T.touches.length!==1)return;const F=T.target.closest("[data-dk]");if(!F||!w.contains(F))return;const I=T.touches[0];d.current.startX=I.clientX,d.current.startY=I.clientY,d.current.pointerX=I.clientX,d.current.pointerY=I.clientY,d.current.moved=!1;const X=F.getAttribute("data-dk");clearTimeout(d.current.timer),d.current.timer=setTimeout(()=>{d.current.moved||P(X)},i)},D=T=>{const F=T.touches[0];if(d.current.pointerX=F.clientX,d.current.pointerY=F.clientY,d.current.dragKey==null){(Math.abs(F.clientX-d.current.startX)>8||Math.abs(F.clientY-d.current.startY)>8)&&(d.current.moved=!0,clearTimeout(d.current.timer));return}(Math.abs(F.clientX-d.current.pickupX)>8||Math.abs(F.clientY-d.current.pickupY)>8)&&(d.current.moved=!0),T.preventDefault(),h()},L=()=>{clearTimeout(d.current.timer),d.current.dragKey!=null&&f()};return w.addEventListener("touchstart",j,{passive:!0}),w.addEventListener("touchmove",D,{passive:!1}),w.addEventListener("touchend",L,{passive:!0}),w.addEventListener("touchcancel",L,{passive:!0}),()=>{w.removeEventListener("touchstart",j),w.removeEventListener("touchmove",D),w.removeEventListener("touchend",L),w.removeEventListener("touchcancel",L)}},[i]);const p=w=>{d.current.suppress&&Date.now()<d.current.suppress&&(w.stopPropagation(),w.preventDefault(),d.current.suppress=0)};return u.jsxs("div",{ref:g,className:"ig-grid",onClickCapture:p,children:[v.map(w=>{const j=t(w);return u.jsx("div",{"data-dk":j,className:"ig-cell"+(c===j?" dragging":""),children:r(w)},j)}),l]})}function Hm({onBack:e,children:t}){const[n,r]=z.useState(0),[o,i]=z.useState(!1),l=z.useRef(null),s=z.useRef(!1),a=d=>{if(d.touches.length!==1||document.querySelector(".overlay"))return;const v=d.touches[0];v.clientX>28||(l.current={x:v.clientX,y:v.clientY},s.current=!1)},c=d=>{if(!l.current)return;const v=d.touches[0],b=v.clientX-l.current.x,S=v.clientY-l.current.y;if(!s.current){if(Math.abs(b)<8&&Math.abs(S)<8)return;if(Math.abs(S)>Math.abs(b)){l.current=null;return}s.current=!0,i(!1)}r(Math.max(0,b))},m=()=>{if(!l.current)return;const d=Math.min(110,window.innerWidth*.3);i(!0),s.current&&n>d?(r(window.innerWidth),setTimeout(e,190)):r(0),l.current=null,s.current=!1},g=n>0?{transform:`translateX(${n}px)`,transition:o?"transform .19s ease-out":"none",boxShadow:"-10px 0 26px rgba(120,50,90,.18)"}:void 0;return u.jsx("div",{className:"swipe-wrap",style:g,onTouchStart:a,onTouchMove:c,onTouchEnd:m,children:t})}const Wm=z.lazy(()=>po(()=>import("./TalkRoom-BHplBmXk.js"),[],import.meta.url)),Vm=z.lazy(()=>po(()=>import("./TodoRoom-1Huu3eBY.js"),[],import.meta.url)),Qm=z.lazy(()=>po(()=>import("./DarelogRoom-Ccs_22Wa.js"),__vite__mapDeps([0,1]),import.meta.url)),Ym=z.lazy(()=>po(()=>import("./ExpenseRoom-cYjU8yuH.js"),[],import.meta.url)),Xm=["💗","🩷","💛","🩵","💜","🤍","🖤","🌸","🌷","🎀","🌟","✨","⭐️","👑","🫶","🐰","🐻","🐱","🦄","🌙","🌊","🌿","🍓","🍒","🧸","📖","💬","✅","🌗","💰"];function Gm(){const[e,t]=z.useState(null),[n,r]=z.useState({screen:"home"}),[o,i]=z.useState(!1),[l,s]=z.useState(""),[a,c]=z.useState(null),[m,g]=z.useState(null),[d,v]=z.useState(!1),[b,S]=z.useState(null),[P,h]=z.useState(""),[f,p]=z.useState(null),[w,j]=z.useState(""),[D,L]=z.useState(0),[T,F]=z.useState(null),I=z.useRef(null),X=z.useRef(0),[he,et]=z.useState(pm),[ut,cn]=z.useState(!1),[tt,ct]=z.useState(""),[M,B]=z.useState(!1),[U,Z]=z.useState(""),[te,ue]=z.useState(""),[J,Ne]=z.useState(null),[we,Et]=z.useState(!1),[nt,dn]=z.useState(null),[Ui,Ae]=z.useState(!1),[Bt,Mn]=z.useState(""),Ut=z.useRef(null),q=(y,C=3e3)=>{Mn(y),clearTimeout(Ut.current),Ut.current=setTimeout(()=>Mn(""),C)};z.useEffect(()=>{(async()=>{try{const y=await mm();y.some(x=>x.id===ke)&&r({screen:"room",roomId:ke}),t(y);const[C,O,R]=await Promise.all([V(Xo),V(lo),V(Dl)]);C&&C.dateKey===Ye()&&h(C.text),Array.isArray(O)&&O.length&&et(O),Ne(R||{})}catch{q("データの読み込みに失敗しました"),t([])}})()},[]),z.useEffect(()=>{if(n.screen!=="home")return;let y=!0;return(async()=>{try{let C=await V(Oe(ke));C=typeof C=="string"?JSON.parse(C):C||{};const O=C[Ye()];if(!y)return;O&&typeof O.text=="string"&&O.text.trim()?F({written:!0,preview:O.text.split(`
`)[0].slice(0,34)}):F({written:!1})}catch{y&&F({written:!1})}})(),()=>{y=!1}},[n.screen,D]),z.useEffect(()=>{n.screen==="home"&&I.current&&(I.current.scrollTop=X.current)},[n.screen]);const fn=y=>{t(C=>{let O=C;return C.find(R=>R.id===ke)||(O=[...C,{id:ke,type:"diary",name:"日記",emoji:"💗",members:[],createdAt:Date.now(),lastAt:0,preview:""}]),O=O.map(R=>R.id===ke?{...R,...y!=null?{preview:y}:{},lastAt:Date.now()}:R),Y(Mt,O),O}),L(C=>C+1)},Ki=async({text:y,time:C,dateKey:O})=>{try{const R=Nn(ke),x=await V(R)||{},k=(x[O]||[]).slice();k.some(N=>N.text===y&&N.time===C)||k.push({text:y,time:C}),await Y(R,{...x,[O]:k}),fn(`🩷 できたこと ☑ ${y}`.slice(0,40))}catch{q("できたことの記録に失敗しました")}},Hi=async({text:y,time:C,dateKey:O})=>{try{const R=Nn(ke),x=await V(R)||{},k=(x[O]||[]).filter(_=>!(_.text===y&&_.time===C)),N={...x};k.length?N[O]=k:delete N[O],await Y(R,N),fn(null)}catch{}},xr=y=>{t(y),Y(Mt,y).catch(()=>q("保存に失敗しました"))},vt=(y,C)=>{t(O=>{const R=O.map(x=>x.id===y?{...x,...C}:x);return Y(Mt,R).catch(()=>q("保存に失敗しました")),R})},Wi=async y=>{const C=y.trim();if(!C)return;const O=Ye();try{await Y(Xo,{dateKey:O,text:C}),h(C);const R=Oe(ke);let x=await V(R);x=x&&typeof x=="object"?x:{};const k=x[O],N=_m(k?k.text:"",C);x={...x,[O]:{text:N,time:k?k.time:hf()}},await Y(R,x);const _=Object.keys(x).sort(),A=_[_.length-1],W=x[A].text.split(`
`)[0].slice(0,40);t(ne=>{let Ce=ne;return ne.find(Fe=>Fe.id===ke)||(Ce=[...ne,{id:ke,type:"diary",name:"日記",emoji:"💗",members:[],createdAt:Date.now(),lastAt:0,preview:""}]),Ce=Ce.map(Fe=>Fe.id===ke?{...Fe,preview:W,lastAt:Date.now()}:Fe),Y(Mt,Ce),Ce}),L(ne=>ne+1),q("今日のコマをピン留めしたよ🩷")}catch{q("宣言の保存に失敗しました")}},ho=y=>{et(y),Y(lo,y).catch(()=>q("マークの保存に失敗しました"))},On=()=>{const y=tt.trim();if(y){if(he.includes(y)){ct("");return}ho([...he,y]),ct("")}},pn=y=>ho(he.filter(C=>C!==y));z.useEffect(()=>{!o||!e||(async()=>{const y={};for(const C of e)y[C.id]=await V(Oe(C.id));c(y)})()},[o,e]);const Rn=e||[],$n=z.useMemo(()=>{if(!l||!a||!e)return null;const y=l.toLowerCase(),C=[];for(const O of Rn){const R=a[O.id],x=[];if(O.type==="diary"){const k=R&&typeof R=="object"?R:{};for(const N of Object.keys(k).sort())(k[N].text+de(N)).toLowerCase().includes(y)&&x.push({snippet:k[N].text.split(`
`)[0],date:de(N)})}else if(O.type==="todo"){const k=R&&Array.isArray(R.todos)?R.todos:[];for(const N of k)(N.text+de(N.dateKey)).toLowerCase().includes(y)&&x.push({snippet:`${N.done?"☑":"☐"} ${N.text.split(`
`)[0]}`,date:de(N.dateKey)})}else if(O.type==="darelog"){const k=R&&Array.isArray(R.records)?R.records:[],N=_=>{var A,W;return((W=(A=O.members)==null?void 0:A.find(ne=>ne.id===_))==null?void 0:W.name)||""};for(const _ of k){const A=N(_.memberId);(A+(_.memo||"")+de(_.dateKey)).toLowerCase().includes(y)&&x.push({snippet:`${A}${_.memo?`: ${_.memo}`:""}`,date:de(_.dateKey)})}}else if(O.type==="expense"){const k=R&&Array.isArray(R.expenses)?R.expenses:[],N=_=>{var A,W;return((W=(A=O.categories)==null?void 0:A.find(ne=>ne.id===_))==null?void 0:W.name)||""};for(const _ of k)(N(_.categoryId)+(_.memo||"")+String(_.amount)+de(_.dateKey)).toLowerCase().includes(y)&&x.push({snippet:`${N(_.categoryId)} ¥${_.amount}${_.memo?" "+_.memo:""}`,date:de(_.dateKey)})}else{const k=R&&Array.isArray(R.messages)?R.messages:[],N=_=>{var A,W;return((W=(A=O.members)==null?void 0:A.find(ne=>ne.id===_))==null?void 0:W.name)||""};for(const _ of k)((_.text+de(_.dateKey)).toLowerCase().includes(y)||N(_.memberId).toLowerCase().includes(y))&&x.push({snippet:`${N(_.memberId)||"？"}: ${_.text.split(`
`)[0]}`,date:de(_.dateKey)})}x.length===0&&O.name.toLowerCase().includes(y)&&x.push({snippet:O.preview||"",date:""}),x.length&&C.push({room:O,hits:x})}return C},[l,a,Rn,e]),hn=y=>l?y.split(new RegExp(`(${mf(l)})`,"gi")).map((O,R)=>O.toLowerCase()===l.toLowerCase()?u.jsx("mark",{className:"hl",children:O},R):O):y,Vi=()=>{const y=m.name.trim();if(!y){q("ルーム名を入れてね");return}const C={diary:"💗",todo:"✅",darelog:"🌗",expense:"💰",talk:"🩷"}[m.type]||"🩷",O=m.type==="darelog"?[{id:Pe(),name:"ヒカルくん",color:"#d4f0ff",icon:{type:"emoji",value:"🌊"},side:"left"},{id:Pe(),name:"柊くん",color:"#d9ffe3",icon:{type:"emoji",value:"🌿"},side:"left"},{id:Pe(),name:"ひかりちゃん",color:"#ffd9ec",icon:{type:"emoji",value:"🌸"},side:"right"}]:[],R=m.type==="expense"?[{id:Pe(),name:"AI費用",emoji:"🤖",color:"#2196F3"},{id:Pe(),name:"ピンクグッズ",emoji:"🎀",color:"#E91E63"},{id:Pe(),name:"ネイル",emoji:"💅",color:"#9C27B0"},{id:Pe(),name:"旅費交通費",emoji:"🚃",color:"#00A5B5",transit:!0}]:void 0,x={id:Pe(),type:m.type,name:y,emoji:m.emoji.trim()||C,theme:m.theme||Pr,members:O,createdAt:Date.now(),lastAt:0,preview:"",...m.type==="todo"?{shopping:!!m.shopping}:{},...R?{categories:R,subscriptions:[],subsPosted:{},transitSeeded:!0,stations:[],fares:[],defaultFromId:null,roundTripDefault:!1,incomeSeeded:!0,incomeCategories:[{id:Pe(),name:"売上",emoji:"💰",color:"#2E9E5B"},{id:Pe(),name:"返金",emoji:"↩️",color:"#3BA7A0"},{id:Pe(),name:"その他",emoji:"✨",color:"#7FB800"}]}:{}};xr([...e,x]),g(null),r({screen:"room",roomId:x.id})},mn=()=>{const y=m.name.trim();if(!y){q("ルーム名を入れてね");return}vt(m.roomId,{name:y,emoji:m.emoji.trim()||"💗",theme:m.theme||Pr,...m.type==="todo"?{shopping:!!m.shopping}:{}}),g(null)},mo=y=>{g({mode:"edit",roomId:y.id,name:y.name,emoji:y.emoji,type:y.type,shopping:!!y.shopping,theme:y.theme||Pr}),v(!1)},Qi=async y=>{try{const C=await V(Oe(y));C&&await Y(fm(y),C),xr(e.filter(O=>O.id!==y)),g(null),S(null),q("ルームを削除しました")}catch{q("削除に失敗しました")}},go=()=>{const y=e.find(C=>C.id===m.roomId);S({message:`ルーム「${(y==null?void 0:y.name)||""}」を削除しますか？
中の記録もすべて消えます。`,onConfirm:()=>Qi(m.roomId)})},Yi=async()=>{ue(""),Ae(!1);try{const y=await Hu();Z(JSON.stringify(y,null,2))}catch{Z("")}B(!0)},In=async()=>{const y={...J||{},lastDateKey:Ye(),lastAt:Date.now()};Ne(y);try{await Y(Dl,y)}catch{}},An=y=>{const C=new Blob([y],{type:"application/json;charset=utf-8"}),O=URL.createObjectURL(C),R=document.createElement("a");R.href=O,R.download=Ro,document.body.appendChild(R),R.click(),R.remove(),setTimeout(()=>URL.revokeObjectURL(O),3e3)},yr=async()=>{if(!we){Et(!0);try{let y;try{y=JSON.stringify(await Hu(),null,2)}catch{q("バックアップの作成に失敗しました 🥺");return}try{const C=new File([y],Ro,{type:"application/json"});if(navigator.canShare&&navigator.canShare({files:[C]})){await navigator.share({files:[C],title:Ro}),await In(),q("バックアップを保存したよ💗 同じファイルに置き換えできたかな？");return}}catch(C){if(C&&(C.name==="AbortError"||C.name==="NotAllowedError"))return}try{An(y),await In(),q("バックアップを保存したよ💗 iCloud/ファイルに入れておくと安心")}catch{q("保存できない環境みたい。コピーを使ってね")}}finally{Et(!1)}}},Xi=()=>{try{An(U),In(),q("バックアップを保存したよ💗 iCloud/ファイルに入れておくと安心")}catch{q("保存できない環境みたい。コピーを使ってね")}},Fn=Ye(),zt=(()=>{if(!(J!=null&&J.lastDateKey))return null;const y=Ke(Fn)-Ke(J.lastDateKey);return Math.max(0,Math.round(y/864e5))})(),wt=zt===null||zt>=7,vr=!!J&&J.lastDateKey!==Fn&&J.dismissedDateKey!==Fn,Gi=async()=>{const y={...J||{},dismissedDateKey:Fn};Ne(y);try{await Y(Dl,y)}catch{}},Ji=async()=>{try{await navigator.clipboard.writeText(U),Ae(!0),setTimeout(()=>Ae(!1),2e3)}catch{q("コピーできませんでした。全選択して手動でコピーしてね")}},Zi=y=>{var R;const C=(R=y.target.files)==null?void 0:R[0];if(!C)return;const O=new FileReader;O.onload=()=>ue(String(O.result||"")),O.onerror=()=>q("ファイルを読めませんでした"),O.readAsText(C),y.target.value=""},qi=()=>{let y;try{y=JSON.parse(te)}catch{q("JSONとして読めませんでした。ファイルが壊れているかも 🥺",4e3);return}const C=Tm(y);if(C){q(C,4500);return}dn({obj:y,counts:Lm(y),exportedAt:y.exportedAt||"",version:y.version})},el=async()=>{const y=nt==null?void 0:nt.obj;if(y)try{const C=await Mm(y);t(C.rooms),y.declaration&&y.declaration.dateKey===Ye()&&!P&&(await Y(Xo,y.declaration),h(y.declaration.text)),L(O=>O+1),dn(null),B(!1),ue(""),q(`復元完了💗 ${C.addedRooms}ルーム / ${C.addedItems}件を追加`)}catch{dn(null),q("復元中にエラーが出ました。ファイルが壊れているかも 🥺",4e3)}};if(!e)return u.jsx("div",{className:"app",children:u.jsx("style",{children:Vu})});const xo=u.jsxs("div",{className:"pin",onClick:()=>{j(P),p(P?"view":"edit")},role:"button",children:[u.jsx("span",{className:"pin-ic",children:P?"📌":"🩷"}),P?u.jsx("span",{className:"pin-txt",children:P}):u.jsx("span",{className:"pin-ph",children:"今日のコマをえらぶ🩷"})]});let kt;if(n.screen==="room"){const y=e.find(C=>C.id===n.roomId);if(!y)kt=null,setTimeout(()=>r({screen:"home"}),0);else{const C={room:y,onBack:()=>r({screen:"home"}),onMeta:R=>vt(y.id,R),initialQuery:n.q,showToast:q,pinned:xo},O=y.type==="diary"?u.jsx(Um,{...C,syncSignal:D,marks:he,onEditMarks:()=>cn(!0)},y.id):y.type==="todo"?u.jsx(Vm,{...C,onTodoComplete:Ki,onTodoUncomplete:Hi,onRoomChange:R=>vt(y.id,R)},y.id):y.type==="darelog"?u.jsx(Qm,{...C,onRoomChange:R=>vt(y.id,R)},y.id):y.type==="expense"?u.jsx(Ym,{...C,onRoomChange:R=>vt(y.id,R)},y.id):u.jsx(Wm,{...C,onRoomChange:R=>vt(y.id,R)},y.id);kt=u.jsx(Hm,{onBack:()=>r({screen:"home"}),children:u.jsx(z.Suspense,{fallback:u.jsxs(u.Fragment,{children:[u.jsx("div",{className:"hd hd-loading"}),u.jsx("div",{className:"chat"})]}),children:O})},y.id)}}else kt=u.jsxs(u.Fragment,{children:[u.jsxs("div",{className:"hd hd-home",children:[u.jsx("div",{className:"app-brand",children:u.jsx("div",{className:"app-title",children:"💖Nachumin Lifelog💖"})}),u.jsx("button",{className:"icon-btn",style:{marginLeft:"auto"},"aria-label":"バックアップ",onClick:Yi,children:"💾"}),u.jsx("button",{className:"icon-btn","aria-label":"新しいルーム",onClick:()=>g({mode:"new",name:"",emoji:"",type:"talk"}),children:"➕"}),u.jsx("button",{className:"icon-btn","aria-label":"ぜんぶ検索",onClick:()=>{i(!o),s("")},children:o?"✕":"🔍"})]}),vr&&u.jsxs("div",{className:"bk-banner"+(wt?" stale":""),children:[u.jsxs("button",{className:"bk-main",onClick:yr,disabled:we,children:[u.jsx("span",{className:"bk-ttl",children:"💾 今日のバックアップ🩷"}),u.jsx("span",{className:"bk-sub",children:zt===null?"まだ一度も保存していません":wt?`最後の保存から ${zt}日 たっています`:"タップで1ファイルに書き出し"})]}),u.jsx("button",{className:"bk-x","aria-label":"閉じる",onClick:Gi,children:"✕"})]}),o&&u.jsx("div",{className:"search-row",children:u.jsx("input",{autoFocus:!0,placeholder:"ぜんぶのルームから検索（ことば・話者・日付）",value:l,onChange:y=>s(y.target.value)})}),$n?u.jsx("div",{className:"rooms",children:$n.length===0?u.jsx("div",{className:"empty",children:"みつかりませんでした 🥺"}):$n.map(({room:y,hits:C})=>u.jsxs("div",{className:"room-row",onClick:()=>r({screen:"room",roomId:y.id,q:l}),children:[u.jsx("div",{className:"r-ic",children:y.emoji}),u.jsxs("div",{className:"r-main",children:[u.jsx("div",{className:"r-name",children:y.name}),u.jsx("div",{className:"r-prev",children:hn(C[0].snippet)})]}),u.jsxs("div",{className:"r-side",children:[u.jsxs("span",{className:"r-badge",children:[C.length,"件"]}),C[0].date&&u.jsx("span",{className:"r-date",children:C[0].date})]})]},y.id))}):u.jsx("div",{className:"home-scroll",ref:I,onScroll:y=>{X.current=y.target.scrollTop},children:(()=>{const y=e.find(k=>k.id===ke),C=Rn.filter(k=>k.id!==ke),O=Ke(Ye()),R=T?T.written?T.preview:`${O.getMonth()+1}/${O.getDate()}・きょうの分はまだ`:"…",x=k=>{const N=[...k];xr(e.map(_=>_.id===ke?_:N.shift()))};return u.jsxs(u.Fragment,{children:[y&&u.jsxs("button",{className:"diary-card",onClick:()=>r({screen:"room",roomId:y.id}),children:[u.jsx("span",{className:"dc-ic",children:y.emoji}),u.jsxs("span",{className:"dc-main",children:[u.jsx("span",{className:"dc-name",children:y.name}),u.jsx("span",{className:"dc-sub",children:R})]}),u.jsx("span",{className:"dc-arw",children:"›"})]}),u.jsx(Km,{items:C,keyOf:k=>k.id,onReorder:x,onLongPress:({item:k})=>{k&&mo(k)},footer:u.jsx("div",{className:"ig-cell ig-add",children:u.jsxs("button",{className:"ig-tile",onClick:()=>g({mode:"new",name:"",emoji:"",type:"talk"}),children:[u.jsx("span",{className:"ig-btn",children:"＋"}),u.jsx("span",{className:"ig-name",children:"つくる"})]})}),renderItem:k=>{const N=k.type==="todo"&&k.todoOpen>0?k.todoOpen:null;return u.jsxs("button",{className:"ig-tile",onClick:()=>r({screen:"room",roomId:k.id}),children:[u.jsxs("span",{className:"ig-btn",style:Wu(k.theme),children:[k.emoji,N!=null&&u.jsx("span",{className:"ig-badge",children:N>99?"99+":N})]}),u.jsx("span",{className:"ig-name",children:k.name})]})}})]})})()})]});return u.jsxs("div",{className:"app",children:[u.jsx("style",{children:Vu}),kt,m&&u.jsx("div",{className:"overlay",onClick:()=>{g(null),v(!1)},children:u.jsxs("div",{className:"panel",onClick:y=>y.stopPropagation(),children:[u.jsx("h3",{children:m.mode==="new"?"➕ 新しいルーム":"⚙️ ルーム設定"}),u.jsx("div",{className:"f-label",children:"ルーム名"}),u.jsx("input",{className:"f-input",autoFocus:m.mode==="new",placeholder:"ハートるんず",value:m.name,onChange:y=>g(C=>({...C,name:y.target.value}))}),u.jsx("div",{className:"f-label",children:"アイコン（タップで選ぶ）"}),u.jsx("div",{className:"emoji-picks",children:Xm.map(y=>u.jsx("button",{className:"emoji-pick"+(m.emoji===y?" on":""),onClick:()=>g(C=>({...C,emoji:y})),children:y},y))}),u.jsx("input",{className:"f-input",style:{width:130,textAlign:"center",marginTop:4},maxLength:8,placeholder:"または自由入力",value:m.emoji,onChange:y=>g(C=>({...C,emoji:y.target.value}))}),u.jsx("div",{className:"f-label",children:"テーマカラー"}),u.jsx("div",{className:"theme-swatches",children:xf.map(y=>{const C=(m.theme||Pr)===y;return u.jsx("button",{className:"theme-sw"+(C?" on":""),style:Wu(y),"aria-label":y,onClick:()=>g(O=>({...O,theme:y}))},y)})}),u.jsxs("div",{className:"f-label",children:["タイプ",m.mode==="edit"?"（変更できません）":""]}),u.jsxs("div",{className:"type-row",children:[u.jsxs("button",{className:"type-chip"+(m.type==="diary"?" on":""),disabled:m.mode==="edit",onClick:()=>g(y=>({...y,type:"diary"})),children:["📖 日記",u.jsx("small",{children:"1日=1吹き出し"})]}),u.jsxs("button",{className:"type-chip"+(m.type==="talk"?" on":""),disabled:m.mode==="edit",onClick:()=>g(y=>({...y,type:"talk"})),children:["💬 トーク",u.jsx("small",{children:"話者ごと"})]}),u.jsxs("button",{className:"type-chip"+(m.type==="todo"?" on":""),disabled:m.mode==="edit",onClick:()=>g(y=>({...y,type:"todo"})),children:["✅ TODO",u.jsx("small",{children:"やること"})]}),u.jsxs("button",{className:"type-chip"+(m.type==="darelog"?" on":""),disabled:m.mode==="edit",onClick:()=>g(y=>({...y,type:"darelog"})),children:["🌗 だれログ",u.jsx("small",{children:"朝昼夜の記録"})]}),u.jsxs("button",{className:"type-chip"+(m.type==="expense"?" on":""),disabled:m.mode==="edit",onClick:()=>g(y=>({...y,type:"expense"})),children:["💰 経費",u.jsx("small",{children:"支出を記録"})]})]}),m.type==="todo"&&u.jsxs(u.Fragment,{children:[u.jsx("div",{className:"f-label",children:"用途"}),u.jsxs("button",{className:"shop-toggle"+(m.shopping?" on":""),onClick:()=>g(y=>({...y,shopping:!y.shopping})),children:[u.jsx("span",{className:"shop-box",children:m.shopping?"✓":""}),"🛒 買い物リストとして使う（よく買うものクイック追加）"]})]}),u.jsxs("div",{className:"panel-btns",children:[u.jsx("button",{className:"p-copy",onClick:m.mode==="new"?Vi:mn,children:m.mode==="new"?"つくる":"保存"}),m.mode==="edit"&&u.jsx("button",{className:"p-del",onClick:go,children:"削除"}),u.jsx("button",{className:"p-close",onClick:()=>{g(null),v(!1)},children:"閉じる"})]})]})}),M&&u.jsx("div",{className:"overlay",onClick:()=>B(!1),children:u.jsxs("div",{className:"panel",onClick:y=>y.stopPropagation(),children:[u.jsx("h3",{children:"💾 まるごとバックアップ"}),u.jsx("p",{className:"panel-note",children:"全ルーム・全データ（日記 / TODO / だれログ / 経費 / 習慣 / 各種設定）を まるごと1ファイルに保存します。端末が変わっても元どおり復元できます。"}),u.jsxs("div",{className:"bk-last"+(wt?" stale":""),children:[u.jsx("span",{className:"bk-last-l",children:"最後にバックアップした日"}),u.jsx("span",{className:"bk-last-v",children:J!=null&&J.lastDateKey?`${de(J.lastDateKey)}${zt===0?"（今日）":`（${zt}日前）`}`:"まだありません"})]}),u.jsxs("div",{className:"panel-btns",children:[u.jsx("button",{className:"p-copy",onClick:yr,disabled:we,children:"💾 1タップで書き出し"}),u.jsx("button",{className:"p-dl",onClick:Xi,children:"ダウンロード"}),u.jsx("button",{className:"p-dl",onClick:Ji,children:Ui?"コピーしたよ💗":"コピー"})]}),u.jsxs("p",{className:"panel-note",children:["ファイル名は毎回 ",u.jsx("b",{children:Ro})," で固定。iPhoneの共有シートから 「ファイルに保存」を選ぶと、前のファイルを置き換えて上書きできます。"]}),u.jsx("div",{className:"f-label",style:{marginTop:6},children:"復元する（バックアップから読み込み）"}),u.jsx("p",{className:"panel-note",children:"既存のデータは消さず、足りない分だけ追加します（安全マージ）"}),u.jsxs("label",{className:"upload-btn",style:{alignSelf:"flex-start"},children:["📂 バックアップファイルを選ぶ",u.jsx("input",{type:"file",accept:".json,application/json,text/plain",onChange:Zi})]}),u.jsx("textarea",{placeholder:"または、コピーしたバックアップをここに貼り付け",value:te,onChange:y=>ue(y.target.value),style:{minHeight:120}}),u.jsxs("div",{className:"panel-btns",children:[u.jsx("button",{className:"p-copy",disabled:!te.trim(),onClick:qi,children:"復元する"}),u.jsx("button",{className:"p-close",onClick:()=>{B(!1),ue("")},children:"閉じる"})]})]})}),nt&&u.jsx("div",{className:"overlay bk-ask-over",onClick:()=>dn(null),children:u.jsxs("div",{className:"panel",onClick:y=>y.stopPropagation(),children:[u.jsx("h3",{children:"⚠️ 復元まえの確認"}),u.jsxs("div",{className:"bk-ask-box",children:[u.jsxs("div",{className:"bk-ask-row",children:[u.jsx("span",{children:"ルーム"}),u.jsx("b",{children:nt.counts.rooms})]}),u.jsxs("div",{className:"bk-ask-row",children:[u.jsx("span",{children:"記録の件数"}),u.jsx("b",{children:nt.counts.items})]}),nt.exportedAt&&u.jsxs("div",{className:"bk-ask-row",children:[u.jsx("span",{children:"書き出し日時"}),u.jsx("b",{children:new Date(nt.exportedAt).toLocaleString("ja-JP")})]})]}),u.jsxs("p",{className:"panel-note",children:["今のデータは消えません（足りない分を追加する安全マージ）。 それでも念のため、",u.jsx("b",{children:"先に今のデータをバックアップ"}),"しておくのがおすすめです💗"]}),u.jsx("button",{className:"bk-first",onClick:yr,disabled:we,children:"💾 先に今のデータをバックアップする"}),u.jsxs("div",{className:"panel-btns",children:[u.jsx("button",{className:"p-copy",onClick:el,children:"この内容で復元する"}),u.jsx("button",{className:"p-close",onClick:()=>dn(null),children:"キャンセル"})]})]})}),f&&u.jsx("div",{className:"overlay",onClick:()=>p(null),children:u.jsxs("div",{className:"panel",onClick:y=>y.stopPropagation(),children:[u.jsx("h3",{children:"🩷 今日のコマ"}),f==="view"?u.jsxs(u.Fragment,{children:[u.jsx("div",{className:"decl-full",children:P}),u.jsx("p",{className:"panel-note",children:"その日1日だけピン留め。日記にも記録されています🎬"}),u.jsxs("div",{className:"panel-btns",children:[u.jsx("button",{className:"p-copy",onClick:()=>{j(P),p("edit")},children:"書きなおす"}),u.jsx("button",{className:"p-close",onClick:()=>p(null),children:"閉じる"})]})]}):u.jsxs(u.Fragment,{children:[u.jsx("textarea",{autoFocus:!0,style:{minHeight:120},placeholder:"今日は愛全開の私でいる！",value:w,onChange:y=>j(y.target.value)}),u.jsx("p",{className:"panel-note",children:"その日1日だけ表示。決定すると今日の日記の先頭に🎬として残ります"}),u.jsxs("div",{className:"panel-btns",children:[u.jsx("button",{className:"p-copy",disabled:!w.trim(),onClick:()=>{Wi(w),p(null)},children:"決定"}),u.jsx("button",{className:"p-close",onClick:()=>p(null),children:"閉じる"})]})]})]})}),ut&&u.jsx("div",{className:"overlay",onClick:()=>cn(!1),children:u.jsxs("div",{className:"panel",onClick:y=>y.stopPropagation(),children:[u.jsx("h3",{children:"⚙︎ 箇条書きマーク"}),u.jsx("p",{className:"panel-note",children:"日記の入力欄に出るマーク。タップで削除、下から追加できます。"}),u.jsxs("div",{className:"mark-manage",children:[he.map(y=>u.jsxs("span",{className:"mark-item",children:[y,u.jsx("button",{onClick:()=>pn(y),"aria-label":"削除",children:"✕"})]},y)),he.length===0&&u.jsx("p",{className:"panel-note",children:"マークがありません。追加してね"})]}),u.jsxs("div",{className:"in-row",style:{marginTop:4},children:[u.jsx("input",{className:"f-input",maxLength:4,placeholder:"記号や絵文字（例: ❤︎）",value:tt,onChange:y=>ct(y.target.value),onKeyDown:y=>y.key==="Enter"&&On()}),u.jsx("button",{className:"p-copy",style:{flex:"0 0 auto",padding:"8px 16px",borderRadius:999},disabled:!tt.trim(),onClick:On,children:"追加"})]}),u.jsx("div",{className:"panel-btns",children:u.jsx("button",{className:"p-close",onClick:()=>cn(!1),children:"閉じる"})})]})}),b&&u.jsx(kf,{message:b.message,onConfirm:b.onConfirm,onCancel:()=>S(null)}),Bt&&u.jsx("div",{className:"toast",children:Bt})]})}let Yu=!1,Xu=!!(navigator.serviceWorker&&navigator.serviceWorker.controller);navigator.serviceWorker&&navigator.serviceWorker.addEventListener("controllerchange",()=>{if(!Xu){Xu=!0;return}Yu||(Yu=!0,window.location.reload())});Gh({immediate:!0,onRegisteredSW(e,t){t&&(t.update(),setInterval(()=>t.update(),60*60*1e3),document.addEventListener("visibilitychange",()=>{document.visibilityState==="visible"&&t.update()}))}});hm();uf(document.getElementById("root")).render(u.jsx(z.StrictMode,{children:u.jsx(Gm,{})}));export{tg as A,Zm as B,Am as C,qm as D,Jm as E,Uu as F,$m as I,cg as M,Qu as P,Cm as S,dg as T,Bu as W,Oe as a,de as b,Ku as c,Si as d,kf as e,Ye as f,V as g,ag as h,mf as i,u as j,Ke as k,Y as l,fg as m,hf as n,ng as o,sg as p,ig as q,z as r,Sm as s,Rm as t,Pe as u,lg as v,rg as w,og as x,ug as y,eg as z};
